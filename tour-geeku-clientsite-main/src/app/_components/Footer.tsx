...
function Footer() {
  return (
    <footer className="text-[#A9AEB9] body-font bg-[#010A15]">
        ...
        <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
          <div className="lg:w-[21%] md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 text-[15px] font-normal cursor-pointer space-y-2">
              ...
              <li>
                <a className="text-[#A9AEB9] hover:text-gray-200">Legal Notice</a>
              </li>
              <li>
                <a className="text-[#A9AEB9] hover:text-gray-200">Privacy Policy</a>
              </li>
              <li>
          ...
          <div className="lg:w-[10%] md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 text-[15px] font-normal cursor-pointer space-y-2">
              ...
              <li>
                <a className="text-[#A9AEB9] hover:text-gray-200">Travel Guides</a>
              </li>
            </nav>
          </div>
      ...
      <div className="mx-auto py-2 px-5 text-center text-[#A9AEB9] text-sm bg-[#010A15]">
        <p>
